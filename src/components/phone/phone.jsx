...
import imgPostobon from '../../assets/iconScenes/postobon.jpeg'
...
export default function Phone(props) {
  ...
  const takePhoto = (photo) => {
    const imgs = {
      imgCoca,imgPostobon,imgPapel,imgMedicamento,imgCigarrillos
    }
    Swal.fire({
      imageUrl: imgs[photo],
      imageHeight: 600,
          ...
          <div className="questions__inner">
            ...
            <div className='mid'>
              ...
              <form className='respuestas' onSubmit={saveAnswer} id={'form'+attrs.numAsk}>
                    ...
                    <button className={'send ' + hide} type='submit'>Enviar</button>
              </form>
